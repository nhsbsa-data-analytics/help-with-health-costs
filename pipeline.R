...
# create a seperate support dataset for live birth data
...
# 4.4.4 HRTPPC: Deprivation profile (narrative = latest year only)------------------------------------------------
# IMD may not be available if the postcode cannot be mapped to NSPL
...
# 4.4.5 HRTPPC: ICB profile (narrative = latest year only)-------------------------------------------------
# ICBs can vary in size and therefore are not appropriate for direct comparison
# Figures should be standardised by a population denominator
# population denominators for each ICB have been defined and applied in the HWHC_BI_ICB_POPULATION database table
...
meta_descs <-
  c(
    ...
    "Where the applicants residential address cannot be assigned to any country via the National Statistics Postcode Lookup (NSPL) - May 2024, the country will be recorded as 'Unknown'.",

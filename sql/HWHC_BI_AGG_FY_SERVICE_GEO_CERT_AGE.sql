...
PowerBI dataset creation: Aggregated figures for age band reporting
Version 1.0
...
DESCRIPTION:
    Aggregate the dataset to support requirements for age band reporting
    ...
    Data should be aggregated by:
        ...
        CUSTOM_AGE_BAND     :   custom 5 year age band groups for each service area
...
create table HWHC_BI_AGG_FY_SERVICE_GEO_CERT_AGE compress for query high as 

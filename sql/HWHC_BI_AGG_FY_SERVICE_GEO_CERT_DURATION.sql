...
PowerBI dataset creation: Aggregated figures for certificate duration reporting
Version 1.0
...
DESCRIPTION:
    Aggregate the dataset to support requirements for certificate duration reporting
    ...
    Data should be aggregated by:
        ...
        CERTIFICATE_DURATION    :   duration of the certificatem based on custom bandings
...
create table HWHC_BI_AGG_FY_SERVICE_GEO_CERT_DURATION compress for query high as 

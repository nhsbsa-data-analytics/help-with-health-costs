...
PowerBI dataset creation: Aggregated figures for IMD reporting
Version 1.0
...
DESCRIPTION:
    Aggregate the dataset to support requirements for IMD quintile reporting
...
create table HWHC_BI_AGG_FY_SERVICE_GEO_CERT_IMD compress for query high as 

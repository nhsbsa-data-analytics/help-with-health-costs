...
PowerBI dataset creation: Aggregated figures for trend reporting (month)
Version 1.0
...
DESCRIPTION:
    Aggregate the dataset to support requirements for trend reporting by year month
...
create table HWHC_BI_AGG_MONTH_SERVICE_GEO_CERT compress for query high as 
